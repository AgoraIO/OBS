...
!ifndef APPVERSION
!define APPVERSION "26.0.0"
!define SHORTVERSION "26.0.0"
...
!ifdef FULL
OutFile "OBS-Studio-${SHORTVERSION}-Full-2017-with-Agora-${AGORASDKVERSION}-x64-Installer.exe"
!else
OutFile "OBS-Studio-${SHORTVERSION}-Small-2017-with-Agora-${AGORASDKVERSION}-x64-Installer.exe"
!endif
...
Section "OBS Studio" SecCore
	...
	File /r "..\..\build\rundir\Release\data"
	SetOutPath "$INSTDIR\bin"
	File /r "..\..\build\rundir\Release\bin\64bit"
	SetOutPath "$INSTDIR\obs-plugins"
	File /r "..\..\build\rundir\Release\obs-plugins\64bit"
...
Section -FinishSection
	...
	WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${APPNAME}" "DisplayIcon" "$INSTDIR\bin\64bit\obs32.exe"
