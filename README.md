...
* Build project with CMake-gui：
    ...
    * Set variables in windows environment:
        * DepsPath 
               ...
               The path where win32 or win64 is located after decompressing [dedependencies2017.zip](github.com/AgoraIO/OBS/releases/download/3.0.0/dependencies2017.zip)
        * QTDir
