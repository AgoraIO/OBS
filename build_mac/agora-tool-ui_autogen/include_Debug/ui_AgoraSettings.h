...
public:
    ...
    QLabel *labelGetInfoMode;
    QComboBox *cmbGetMode;
    QLabel *labelGetInfoMode_2;
    ...
    void setupUi(QDialog *AgoraSettings)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 684, 441));
        ...
        formLayout_22->setWidget(6, QFormLayout::LabelRole, label_appid);
        ...
        formLayout_22->setLayout(13, QFormLayout::FieldRole, horizontalLayout_27);

        chkAutoLoadConfig = new QCheckBox(generalGroupBox);
        chkAutoLoadConfig->setObjectName(QString::fromUtf8("chkAutoLoadConfig"));

        formLayout_22->setWidget(16, QFormLayout::FieldRole, chkAutoLoadConfig);

        chkPersistSaving = new QCheckBox(generalGroupBox);
        chkPersistSaving->setObjectName(QString::fromUtf8("chkPersistSaving"));

        formLayout_22->setWidget(14, QFormLayout::FieldRole, chkPersistSaving);

        chkMuteAllRemoteAV = new QCheckBox(generalGroupBox);
        chkMuteAllRemoteAV->setObjectName(QString::fromUtf8("chkMuteAllRemoteAV"));

        formLayout_22->setWidget(14, QFormLayout::LabelRole, chkMuteAllRemoteAV);

        chkPersistSaveAppid = new QCheckBox(generalGroupBox);
        chkPersistSaveAppid->setObjectName(QString::fromUtf8("chkPersistSaveAppid"));

        formLayout_22->setWidget(15, QFormLayout::FieldRole, chkPersistSaveAppid);

        labUrl = new QLabel(generalGroupBox);
        labUrl->setObjectName(QString::fromUtf8("labUrl"));

        formLayout_22->setWidget(5, QFormLayout::LabelRole, labUrl);

        lineEditUrl = new QLineEdit(generalGroupBox);
        lineEditUrl->setObjectName(QString::fromUtf8("lineEditUrl"));

        formLayout_22->setWidget(5, QFormLayout::FieldRole, lineEditUrl);

        labelGetInfoMode = new QLabel(generalGroupBox);
        labelGetInfoMode->setObjectName(QString::fromUtf8("labelGetInfoMode"));

        formLayout_22->setWidget(3, QFormLayout::LabelRole, labelGetInfoMode);

        cmbGetMode = new QComboBox(generalGroupBox);
        cmbGetMode->addItem(QString());
        cmbGetMode->addItem(QString());
        cmbGetMode->setObjectName(QString::fromUtf8("cmbGetMode"));

        formLayout_22->setWidget(3, QFormLayout::FieldRole, cmbGetMode);


        verticalLayout_24->addWidget(generalGroupBox);

        labelGetInfoMode_2 = new QLabel(widget_agora);
        labelGetInfoMode_2->setObjectName(QString::fromUtf8("labelGetInfoMode_2"));
        labelGetInfoMode_2->setStyleSheet(QString::fromUtf8("color: rgb(255, 0, 0);"));

        verticalLayout_24->addWidget(labelGetInfoMode_2);
        ...
        scrollAreaWidgetContents_50->setGeometry(QRect(0, 0, 659, 251));
    ...
    void retranslateUi(QDialog *AgoraSettings)
    {
        ...
        labUrl->setText(QCoreApplication::translate("AgoraSettings", "Agora.Settings.Agora.APPTOKEN.URL", nullptr));
        labelGetInfoMode->setText(QCoreApplication::translate("AgoraSettings", "Agora.Settings.GetInfo.Mode", nullptr));
        cmbGetMode->setItemText(0, QCoreApplication::translate("AgoraSettings", "Agora.Settings.GetInfo.Mode.Manaul", nullptr));
        cmbGetMode->setItemText(1, QCoreApplication::translate("AgoraSettings", "Agora.Settings.GetInfo.Mode.Http.Get", nullptr));

        labelGetInfoMode_2->setText(QCoreApplication::translate("AgoraSettings", "Agora.Settings.GetInfo.Mode.Information", nullptr));
