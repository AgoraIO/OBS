...
public:
    ...
    void setupUi(QDialog *AgoraSettings)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 534, 314));
        ...
        formLayout_22->setWidget(11, QFormLayout::LabelRole, chkPersistSaving);

        chkMuteAllRemoteAV = new QCheckBox(generalGroupBox);
        chkMuteAllRemoteAV->setObjectName(QString::fromUtf8("chkMuteAllRemoteAV"));

        formLayout_22->setWidget(11, QFormLayout::FieldRole, chkMuteAllRemoteAV);
        ...
        formLayout_22->setWidget(12, QFormLayout::FieldRole, chkAutoLoadConfig);
        ...
        scrollAreaWidgetContents_50->setGeometry(QRect(0, 0, 698, 423));
        ...
        formLayout_3->setWidget(5, QFormLayout::FieldRole, videoMsg);
        ...
        formLayout_3->setWidget(1, QFormLayout::FieldRole, cmbAgoraFPS);
        ...
        formLayout_3->setWidget(2, QFormLayout::FieldRole, cmbAgoraBitrate);

        cmbAgoraVideoDevice = new QComboBox(videoPage);
        cmbAgoraVideoDevice->setObjectName(QString::fromUtf8("cmbAgoraVideoDevice"));

        formLayout_3->setWidget(3, QFormLayout::FieldRole, cmbAgoraVideoDevice);
