...
struct AccessToken {
  ...
  AccessToken(const std::string& appId, const std::string& appCertificate,
	      const std::string &channelName, uint32_t seconds, uint32_t uid = 0);

  AccessToken(const std::string& appId, const std::string& appCertificate,
	      const std::string &channelName, uint32_t seconds,
	      const std::string &uid = "");
...
inline void AccessToken::AddPrivilege(Privileges privilege, uint32_t expireTimestamp) {
  message_.messages[privilege] = message_.ts;
}
