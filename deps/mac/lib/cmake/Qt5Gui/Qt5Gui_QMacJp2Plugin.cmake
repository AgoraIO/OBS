...
_populate_Gui_plugin_properties(QMacJp2Plugin RELEASE "imageformats/libqmacjp2.a" FALSE)
...
set(_user_specified_genex_versionless
    "$<IN_LIST:Qt::QMacJp2Plugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
    ...
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                ...
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QMacJp2Plugin,QT_PLUGIN_EXTENDS>,Qt::Gui>,"
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QMacJp2Plugin,QT_PLUGIN_EXTENDS>,>"
            ">,"
            "$<NOT:$<IN_LIST:Qt5::QMacJp2Plugin,${_no_plugins_genex}>>,"
            "$<NOT:$<IN_LIST:Qt::QMacJp2Plugin,${_no_plugins_genex}>>"
        ">"
    ">:Qt5::QMacJp2Plugin>"
)
