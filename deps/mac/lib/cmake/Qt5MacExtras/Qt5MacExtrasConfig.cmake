        ...
        foreach(_flag ${_static_depends})
            ...
            elseif(_framework_flag OR _flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    find_library(_Qt5MacExtras_${Configuration}_${_lib}_PATH ${_lib} HINTS ${CMAKE_CXX_IMPLICIT_LINK_DIRECTORIES})
...
if (NOT TARGET Qt5::MacExtras)
    ...
    set(Qt5MacExtras_PRIVATE_INCLUDE_DIRS
        "${_qt5MacExtras_install_prefix}/include/QtMacExtras/5.15.2"
        "${_qt5MacExtras_install_prefix}/include/QtMacExtras/5.15.2/QtMacExtras"
    )
    ...
    _populate_MacExtras_target_properties(RELEASE "libQt5MacExtras.a" "" FALSE)
