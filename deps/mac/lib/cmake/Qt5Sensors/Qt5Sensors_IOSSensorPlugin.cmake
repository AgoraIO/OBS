...
_populate_Sensors_plugin_properties(IOSSensorPlugin RELEASE "sensors/libqtsensors_ios.a" FALSE)
...
set(_user_specified_genex_versionless
    "$<IN_LIST:Qt::IOSSensorPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
    ...
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                ...
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::IOSSensorPlugin,QT_PLUGIN_EXTENDS>,Qt::Sensors>,"
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::IOSSensorPlugin,QT_PLUGIN_EXTENDS>,>"
            ">,"
            "$<NOT:$<IN_LIST:Qt5::IOSSensorPlugin,${_no_plugins_genex}>>,"
            "$<NOT:$<IN_LIST:Qt::IOSSensorPlugin,${_no_plugins_genex}>>"
        ">"
    ">:Qt5::IOSSensorPlugin>"
)
